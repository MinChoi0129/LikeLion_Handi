...
const sub_text = document.querySelector('.FirstSection').querySelector('.SubText');
...
const second_text = document.querySelector('.SecondSection').querySelector('h2');
const second_sub_text = document.querySelector('.SecondSection').querySelector('.SubText');
